        ...
        <main className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white">
            ...
            <div className="rounded-lg p-4 mb-4 border-2 border-blue-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=blue&ban=-1`} className="w-96 px-2 py-1 text-blue-800" readOnly/>
            ...
            <div className="rounded-lg p-4 mb-4 border-2 border-red-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=red&ban=-1`} className="w-96 px-2 py-1 text-red-800" readOnly/>
            ...
            <div className="rounded-lg p-4 mb-4 border-2 border-gray-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=spec`} className="w-96 px-2 py-1 text-gray-800" readOnly/>
