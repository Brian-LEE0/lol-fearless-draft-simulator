        ...
        <main className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white">
            ...
            <div className="rounded-lg p-4 mb-4 border-2 border-blue-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=blue&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`} className="w-96 px-2 py-1 text-blue-800" readOnly/>
                    <button className="px-2 py-1 bg-blue-600 rounded-lg hover:bg-blue-700"
                        onClick={() => {
                            window.open(`${base_url}/rooms/${decodeURI(room_id)}?side=blue&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`, '_blank');
                        }}
                    > 바로 가기 </button>
                </div>
            </div>
            <div className="rounded-lg p-4 mb-4 border-2 border-red-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=red&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`} className="w-96 px-2 py-1 text-red-800" readOnly/>
                    <button className="px-2 py-1 bg-red-600 rounded-lg hover:bg-red-700"
                        onClick={() => {
                            window.open(`${base_url}/rooms/${decodeURI(room_id)}?side=red&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`, '_blank');
                        }}
                    > 바로 가기 </button>
                </div>
            </div>
            <div className="rounded-lg p-4 mb-4 border-2 border-gray-500">
                ...
                <div className="flex flex-row items-center justify-center">
                    <input type="text" value={`${base_url}/rooms/${decodeURI(room_id)}?side=spec&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`} className="w-96 px-2 py-1 text-gray-800" readOnly/>
                    <button className="px-2 py-1 bg-gray-600 rounded-lg hover:bg-gray-700"
                        onClick={() => {
                            window.open(`${base_url}/rooms/${decodeURI(room_id)}?side=spec&ban=6rCc67Cc7J6Q64KY64KY7J207Iqs`, '_blank');
                        }}> 바로 가기 </button>
                </div>
            </div>
        </main>
